...
public class DBHelp extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_BOOKMARKS =
            "CREATE TABLE " + PersistenceContract.Bookmarks.TABLE_NAME + " (" +
                    ...
                    PersistenceContract.Bookmarks.COLUMN_NAME_ADDRESS + TEXT_TYPE + COMMA_SEP +
                    " )";
    private static final String SQL_CREATE_HISTORY =
            "CREATE TABLE " + PersistenceContract.Bookmarks.TABLE_NAME + " (" +
                    ...
                    PersistenceContract.History.COLUMN_NAME_TIME + TEXT_TYPE + COMMA_SEP +
                    " )";
